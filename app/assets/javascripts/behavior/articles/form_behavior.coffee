namespace "Article.FormBehavior", (exports) ->
  ...
  callback = (data) ->
    ...
    type_field = document.getElementById('article_type_id')
  ...
  send_new_type_request = (e) ->
    ...
    category_id = get_select_value(document.getElementById('article_category_id'))
    section = 'article'
  ...
  exports.initialize = () ->
    field = document.getElementById('article_category_id')
...
domReady ->
  ...
  #$("#article_body").markItUp(mySettings);
