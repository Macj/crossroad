...
Article.create( :name => "Статья", :category_id => 2, :autor_id => nil,:body => "Test body for test article", :sources => 'test.article.dp.ua',  :autor =>  'Crossroad', :type_id =>1)
Article.create( :name => "Статья2", :category_id => 3, :autor_id => nil, :body => "Test body for test article2", :sources => 'test.article2.dp.ua',  :autor => 'Crossroad', :type_id => 1)
...
Place.create(name: 'Тестовое место', category_id: 2, type_id: 1,  description: "Мысто себе из категории #{Category.find(2).name} типа #{Type.find(1).name}", web_links: "place.dp.ua")
Place.create(name: 'Тестовое место', category_id: 3, type_id: 2,  description: "Мысто себе из категории #{Category.find(3).name} типа #{Type.find(2).name}", web_links: "place.dp.ua")
Place.create(name: 'Тестовое место', category_id: 4, type_id: 3,  description: "Мысто себе из категории #{Category.find(4).name} типа #{Type.find(3).name}", web_links: "place.dp.ua")
Place.create(name: 'Тестовое место', category_id: 5, type_id: 4,  description: "Мысто себе из категории #{Category.find(5).name} типа #{Type.find(4).name}", web_links: "place.dp.ua")
Place.create(name: 'Тестовое место', category_id: 6, type_id: 5,  description: "Мысто себе из категории #{Category.find(6).name} типа #{Type.find(5).name}", web_links: "place.dp.ua")
Place.create(name: 'Тестовое место', category_id: 7, type_id: 6,  description: "Мысто себе из категории #{Category.find(7).name} типа #{Type.find(6).name}", web_links: "place.dp.ua")
Place.create(name: 'Тестовое место', category_id: 8, type_id: 7,  description: "Мысто себе из категории #{Category.find(8).name} типа #{Type.find(7).name}", web_links: "place.dp.ua")
