...
Article.create( :name => "arty", :category_id => 2, :author_id => nil,:body => "Test body for test article", :sources => 'test.article.dp.ua',  :author =>  'Crossroad', :type_id =>1)
Article.create( :name => "arty2", :category_id => 3, :author_id => nil, :body => "Test body for test article2", :sources => 'test.article2.dp.ua',  :author => 'Crossroad', :type_id => 1)
